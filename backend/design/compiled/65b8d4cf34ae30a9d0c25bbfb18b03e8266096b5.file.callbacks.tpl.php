<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-07-18 07:08:03
         compiled from "backend/design/html/callbacks.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17416683645d301ad31aabd3-62855610%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '65b8d4cf34ae30a9d0c25bbfb18b03e8266096b5' => 
    array (
  ...
  'nocache_hash' => '17416683645d301ad31aabd3-62855610',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d301ad322aba5_16722263',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d301ad322aba5_16722263')) {function content_5d301ad322aba5_16722263($_smarty_tpl) {?>
<?php $_smarty_tpl->tpl_vars['meta_title'] = new Smarty_variable($_smarty_tpl->tpl_vars['btr']->value->callbacks_order, null, 1);
...
"></label>
 ...
 <span class="tag tag-default"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['date'][0][0]->date_modifier($_smarty_tpl->tpl_vars['callback']->value->date);?>
 | <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['time'][0][0]->time_modifier($_smarty_tpl->tpl_vars['callback']->value->date);?>
</span>
...
" target="_blank"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['callback']->value->url, ENT_QUOTES, 'UTF-8', true);?>
                                            ...
                                            <div class="hidden-md-up mt-q">
                                                <button type="button" class="btn btn_small btn-outline-warning fn_ajax_action fn_callbacks_toggle <?php if ($_smarty_tpl->tpl_vars['callback']->value->processed) {?>hidden<?php }?>" data-module="callback" data-action="processed" data-id="<?php echo $_smarty_tpl->tpl_vars['callback']->value->id;?>
">
                                                    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->general_process, ENT_QUOTES, 'UTF-8', true);?>

                                                </button>
                                                <button type="button" class="btn btn_small btn-outline-warning fn_ajax_action fn_callbacks_toggle fn_active_class <?php if (!$_smarty_tpl->tpl_vars['callback']->value->processed) {?>hidden<?php }?>" data-module="callback" data-action="processed" data-id="<?php echo $_smarty_tpl->tpl_vars['callback']->value->id;?>
">
